  ...
  return (
    <>
      <Link
        ...
        target="_blank"
        className="fixed bottom-20 right-6 z-50 rounded-full bg-[#25D366] p-3 lg:right-10 2xl:bottom-10"
      >
        <svg
      ...
      <Link
        ...
        target="_blank"
        className="fixed bottom-36 right-6 z-50 rounded-full bg-black p-3 lg:right-10 2xl:bottom-32"
      >
        <svg
          viewBox="0 0 128 128"
          fill="none"
